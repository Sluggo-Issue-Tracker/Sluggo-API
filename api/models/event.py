...
class Event(models.Model):
    ...
    events = [(CREATE, "Create"), (UPDATE, "Update"), (DELETE, "Delete")]
    ...
    team = models.ForeignKey(
        Team, on_delete=models.CASCADE, editable=True, null=False, related_name="event"
    )
    ...
    def __str__(self):
        return (
            f"Event: {self.event_type}, {self.description} for Team: {self.team.name}"
        )
