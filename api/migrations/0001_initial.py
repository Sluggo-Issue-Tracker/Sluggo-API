...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"ordering": ["created"], "unique_together": {("tag", "ticket")}},
        ),
        migrations.CreateModel(
            name="TicketStatus",
            fields=[
            ...
            options={"ordering": ["id"], "unique_together": {("title", "team")}},
        ),
        migrations.CreateModel(
            name="TicketNode",
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={"ordering": ["id"], "unique_together": {("user", "team")}},
        ),
        migrations.AlterUniqueTogether(name="tag", unique_together={("title", "team")}),
        migrations.CreateModel(
            name="PinnedTicket",
            fields=[
                (
            ...
            options={"ordering": ["pinned"], "unique_together": {("ticket", "member")}},
        ),
        migrations.AlterUniqueTogether(
            name="member", unique_together={("owner", "team")}
        ),
    ]
